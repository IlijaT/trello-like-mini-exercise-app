...
<div class="bg-pink-200 w-full h-screen font-sans">
    @include('navbar')

    <div class="flex">
        <div class="bg-pink-300 px-2 pt-4 pb-8 h-screen border-r border-pink-700">
            <form wire:submit.prevent="addGroup">
                <div>
                    <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500"   placeholder="Group name..." type="text" wire:model.lazy="newGroupLabel">
                </div>
